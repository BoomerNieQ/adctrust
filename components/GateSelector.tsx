...
const GATES = [
  {
    ...
    icon: "🗺️",
    hint: "Type the incantation",
    bg: "linear-gradient(135deg, #1a0f00 0%, #0f0900 100%)",
    border: "rgba(199,152,45,0.4)",
    accent: "#C7982D",
    glow: "rgba(199,152,45,0.12)",
  },
  {
    id: "lotr",
    ...
    bg: "linear-gradient(135deg, #060c18 0%, #040810 100%)",
    border: "rgba(200,224,248,0.3)",
    accent: "#c8e0f8",
    glow: "rgba(100,160,240,0.1)",
  },
  {
    id: "dhl",
    title: "DHL Express",
    subtitle: "Pakket bezorging",
    icon: "📦",
    hint: "Volg uw waybill",
    bg: "linear-gradient(135deg, #1a0303 0%, #0f0202 100%)",
    border: "rgba(212,5,17,0.45)",
    accent: "#FFCC00",
    glow: "rgba(212,5,17,0.1)",
  },
];
...
export default function GateSelector({ onSelect }: { onSelect: (id: string) => void }) {
  return (
    <div
      className="fixed inset-0 z-[999] flex flex-col items-center justify-center px-5"
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-2xl">
        {GATES.map((gate, i) => (
          ...
          >
            ...
            <div>
              <p style={{ color: gate.accent, fontSize: "16px", fontWeight: 700, marginBottom: "3px" }}>
                {gate.title}
              </p>
              <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "9px", letterSpacing: "3px" }}>
                {gate.subtitle.toUpperCase()}
              </p>
            </div>
